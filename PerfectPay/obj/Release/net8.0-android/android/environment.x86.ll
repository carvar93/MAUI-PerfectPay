...
@dso_cache = dso_local local_unnamed_addr global [480 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 332601516, ; hash 0x13d318ac, from name: PerfectPay.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 592124430, ; hash 0x234b1a0e, from name: aot-PerfectPay.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-PerfectPay.dll.so
		ptr null; void* handle (0x0)
	}, ; 59
	...
	%struct.DSOCacheEntry {
		i64 899490887, ; hash 0x359d2447, from name: aot-PerfectPay
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-PerfectPay.dll.so
		ptr null; void* handle (0x0)
	}, ; 95
	...
	%struct.DSOCacheEntry {
		i64 1666825972, ; hash 0x6359bef4, from name: libaot-PerfectPay.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-PerfectPay.dll.so
		ptr null; void* handle (0x0)
	}, ; 176
	...
	%struct.DSOCacheEntry {
		i64 2977826434, ; hash 0xb17e0682, from name: libaot-PerfectPay
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-PerfectPay.dll.so
		ptr null; void* handle (0x0)
	}, ; 340
	...
	%struct.DSOCacheEntry {
		i64 3411595398, ; hash 0xcb58d086, from name: PerfectPay
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-PerfectPay.dll.so
		ptr null; void* handle (0x0)
	}, ; 390
