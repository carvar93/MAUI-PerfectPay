...
@dso_cache = dso_local local_unnamed_addr global [480 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 1659221120475559439, ; hash 0x1706bcd171c5760f, from name: aot-PerfectPay
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-PerfectPay.dll.so
		ptr null; void* handle (0x0)
	}, ; 36
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 5305708246426705199, ; hash 0x49a1a98a0e1fdd2f, from name: aot-PerfectPay.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-PerfectPay.dll.so
		ptr null; void* handle (0x0)
	}, ; 127
	...
	%struct.DSOCacheEntry {
		i64 7860152937360043609, ; hash 0x6d14df739f96ae59, from name: libaot-PerfectPay.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-PerfectPay.dll.so
		ptr null; void* handle (0x0)
	}, ; 189
	...
	%struct.DSOCacheEntry {
		i64 10433489413925144444, ; hash 0x90cb3357ccce877c, from name: PerfectPay.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-PerfectPay.dll.so
		ptr null; void* handle (0x0)
	}, ; 264
	...
	%struct.DSOCacheEntry {
		i64 13223256817547376404, ; hash 0xb782720407ac7714, from name: PerfectPay
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-PerfectPay.dll.so
		ptr null; void* handle (0x0)
	}, ; 343
	...
	%struct.DSOCacheEntry {
		i64 14017521706473610599, ; hash 0xc2883db959afdd67, from name: libaot-PerfectPay
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-PerfectPay.dll.so
		ptr null; void* handle (0x0)
	}, ; 366
...
@.env.3 = private unnamed_addr constant [37 x i8] c"234f302a-da63-46ab-8784-a74cd680cbfc\00", align 16
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [25 x i8] c"libaot-PerfectPay.dll.so\00", align 16
